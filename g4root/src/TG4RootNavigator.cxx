...
///                     or daughter of that volume's ancestor.
   ...
   if(fG4TrackingManager) {
     ...
     if(currG4TrackId < fTrackGeoStates.size() && fTrackGeoStates[currG4TrackId]) {
...
//______________________________________________________________________________
void TG4RootNavigator::ResetGeoStates()
{
