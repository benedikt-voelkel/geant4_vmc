...
/// \file ExMEDetectorConstruction.cxx
/// \brief Implementation of the ExMEDetectorConstruction class
///
...
/// \cond CLASSIMP
ClassImp(ExMEDetectorConstruction)
/// \endcond

//_____________________________________________________________________________
ExMEDetectorConstruction::ExMEDetectorConstruction()
  : TObject(),
    fNbOfLayers(0),
    fWorldSizeX(0.),
    fWorldSizeYZ(0.),
...
//_____________________________________________________________________________
void ExMEDetectorConstruction::ComputeCalorParameters()
{
...
//_____________________________________________________________________________
void ExMEDetectorConstruction::ConstructMaterials()
{
...
//_____________________________________________________________________________
void ExMEDetectorConstruction::ConstructGeometry()
{
...
//_____________________________________________________________________________
void ExMEDetectorConstruction::SetCuts()
{
...
//_____________________________________________________________________________
void ExMEDetectorConstruction::SetControls()
{
...
//_____________________________________________________________________________
void ExMEDetectorConstruction::PrintCalorParameters()
{
...
//_____________________________________________________________________________
void ExMEDetectorConstruction::SetNbOfLayers(Int_t value)
{
...
//_____________________________________________________________________________
void ExMEDetectorConstruction::SetDefaultMaterial(const TString& materialName)
{
...
//_____________________________________________________________________________
void ExMEDetectorConstruction::SetAbsorberMaterial(const TString& materialName)
{
...
//_____________________________________________________________________________
void ExMEDetectorConstruction::SetGapMaterial(const TString& materialName)
{
/// Set gap material
...
//_____________________________________________________________________________
void ExMEDetectorConstruction::SetCalorSizeYZ(Double_t value)
{
...
//_____________________________________________________________________________
void ExMEDetectorConstruction::SetAbsorberThickness(Double_t value)
{
...
//_____________________________________________________________________________
void ExMEDetectorConstruction::SetGapThickness(Double_t value)
{
...
/*
//_____________________________________________________________________________
void ExMEDetectorConstruction::UpdateGeometry()
{
