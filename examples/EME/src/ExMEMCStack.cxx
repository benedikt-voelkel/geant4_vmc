...
/// \file EME/src/ExMEMCStack.cxx
/// \brief Implementation of the ExMEMCStack class
///
...
/// \cond CLASSIMP
ClassImp(ExMEMCStack)
/// \endcond

//_____________________________________________________________________________
ExMEMCStack::ExMEMCStack(Int_t size)
  : fParticles(0),
    fCurrentTrack(-1),
    fNPrimary(0)
{
...
//_____________________________________________________________________________
void  ExMEMCStack::PushTrack(Int_t toBeDone, Int_t parent, Int_t pdg,
...
//_____________________________________________________________________________
TParticle* ExMEMCStack::PopNextTrack(Int_t& itrack)
{
...
//_____________________________________________________________________________
TParticle* ExMEMCStack::PopPrimaryForTracking(Int_t i)
{
...
//_____________________________________________________________________________
void ExMEMCStack::Print(Option_t* /*option*/) const
{
/// Print info for all particles.

  cout << "ExMEMCStack Info  " << endl;
...
//_____________________________________________________________________________
void  ExMEMCStack::SetCurrentTrack(Int_t track)
{
...
//_____________________________________________________________________________
Int_t  ExMEMCStack::GetNtrack() const
{
...
//_____________________________________________________________________________
Int_t  ExMEMCStack::GetNprimary() const
{
...
//_____________________________________________________________________________
TParticle*  ExMEMCStack::GetCurrentTrack() const
{
...
//_____________________________________________________________________________
Int_t  ExMEMCStack::GetCurrentTrackNumber() const
{
...
//_____________________________________________________________________________
Int_t  ExMEMCStack::GetCurrentParentTrackNumber() const
{
...
//_____________________________________________________________________________
TParticle*  ExMEMCStack::GetParticle(Int_t id) const
{
