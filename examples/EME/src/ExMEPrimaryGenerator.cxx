...
/// \file ExMEPrimaryGenerator.cxx
/// \brief Implementation of the ExMEPrimaryGenerator class
///
...
/// \cond CLASSIMP
ClassImp(ExMEPrimaryGenerator)
/// \endcond

//_____________________________________________________________________________
ExMEPrimaryGenerator::ExMEPrimaryGenerator(TVirtualMCStack* stack)
  : TObject(),
    fStack(stack),
    fIsRandom(false),
...
//_____________________________________________________________________________
ExMEPrimaryGenerator::ExMEPrimaryGenerator(const ExMEPrimaryGenerator& origin,
...
//_____________________________________________________________________________
ExMEPrimaryGenerator::ExMEPrimaryGenerator()
  : TObject(),
    fStack(0),
    fIsRandom(false),
    fPrimaryType(kDefault),
...
//_____________________________________________________________________________
void ExMEPrimaryGenerator::GeneratePrimary1(const TVector3& origin)
{
...
//_____________________________________________________________________________
void ExMEPrimaryGenerator::GeneratePrimary2(const TVector3& origin)
{
...
//_____________________________________________________________________________
void ExMEPrimaryGenerator::GeneratePrimary3(const TVector3& origin)
{
...
//_____________________________________________________________________________
void ExMEPrimaryGenerator::GeneratePrimary4(const TVector3& origin)
{
/// Add light anti-ions:
...
//_____________________________________________________________________________
void ExMEPrimaryGenerator::GeneratePrimary5(const TVector3& origin)
{
...
//_____________________________________________________________________________
void ExMEPrimaryGenerator::GeneratePrimaries(const TVector3& origin)
{
