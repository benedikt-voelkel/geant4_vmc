...
/// \file  ExMEDetectorConstruction.h
/// \brief Definition of the ExMEDetectorConstruction class
///
...
class ExMEDetectorConstruction : public TObject
{
  public:
    ExMEDetectorConstruction();
    virtual ~ExMEDetectorConstruction();
  ...
  ClassDef(ExMEDetectorConstruction,1) //ExMEDetectorConstruction
};
