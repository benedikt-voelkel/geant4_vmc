...
/// \file testEME.cxx
/// \brief The Geant4 VMC example EME test application
///
...
///  --root-macro 'test_EME_1.C("",kFALSE)'
/// </pre>
///
/// \date 26/02/2014
...
#include "TGeant4.h"
#include "ExMERunConfiguration1.h"
#include "ExMERunConfiguration2.h"
#include "ExMERunConfiguration3.h"
...
void PrintUsage(const std::string& programName)
{
  std::cerr << "\nUsage:\n"
            ...
            << "                                  (geometry, regions, physics-list, field)\n"
#endif
            << "   [-r4m,  --root-macro]:         Root macro\n"
            << "   [-v,    --verbose]:            verbose option (yes,no)"
            << std::endl;
       ...
       const std::string& rootMacro)
{
  std::cout << " Running: \n"
            << " " << programName << "\n"
            << "     --g3-geometry:        " << g3Geometry << "\n";
  if ( rootMacro.size() ) {
    std::cout << "     --root-macro]:    " << rootMacro;
  }
  std::cout << std::endl;
}
#endif
...
int main(int argc, char** argv)
{
  ...
  if ( verbose == "yes" ) {
    ...
    PrintG4Configuration(
      "testEME", g4Geometry, g4PhysicsList, g4SpecialPhysics,
      g4Macro, g4VisMacro, g4Session, g4UserClass, rootMacro);
#endif
#ifdef USE_GEANT3
    PrintG3Configuration(
      "testEME", g3Geometry, rootMacro);
#endif
  }
  //
  ...
  ExMEMCApplication* appl
    =  new ExMEMCApplication("ExampleEME",
                             "The exampleEME MC application");
  ...
  if ( ! g4UserClass.size() ) {
    ...
    runConfiguration
      = new ExMERunConfiguration1(g4PhysicsList, g4SpecialPhysics);
  }
  else if ( g4UserClass == "physics-list" ) {
    runConfiguration
      = new ExMERunConfiguration2(g4Geometry, g4SpecialPhysics);
  }
  else if ( g4UserClass == "regions" ) {
    runConfiguration
      = new ExMERunConfiguration3(g4Geometry, g4PhysicsList, g4SpecialPhysics);
  }
  else if ( g4UserClass == "field" ) {
    runConfiguration
      = new ExMERunConfiguration4(g4Geometry, g4PhysicsList, g4SpecialPhysics);
  }
  else {
    PrintUsage("testEME");
    return 1;
