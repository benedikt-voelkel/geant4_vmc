...
void test_EME_multi(const TString& configMacro1, const TString& configMacro2, Int_t level=0)
{
...
/// Run 5 events with 20 primaries and print the calorimeter hits.
  ...
  if ( ! TVirtualMCApplication::Instance() ) {
    new ExMEMCApplication("ExampleME", "The exampleME MC application", kTRUE);
    needDelete = kTRUE;
  }
