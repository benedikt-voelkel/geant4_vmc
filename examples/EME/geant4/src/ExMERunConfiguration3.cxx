...
/// \file ExMERunConfiguration3.cxx
/// \brief Implementation of the ExMERunConfiguration3 class
///
...
ExMERunConfiguration3::ExMERunConfiguration3(const TString& userGeometry,
...
//_____________________________________________________________________________
ExMERunConfiguration3::~ExMERunConfiguration3()
{
/// Destructor
}
...
//_____________________________________________________________________________
TG4VUserRegionConstruction*  ExMERunConfiguration3::CreateUserRegionConstruction()
{
...
/// construction class from the Geant4 novice example N03 library.
  ...
  return new ExMERegionConstruction();
}
