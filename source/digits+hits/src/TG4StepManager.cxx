...
{
/// A transported track obtained from the VMC stack might already have a history
/// and therefore e.g. a step number != 0
...
/// Not updated in Gflash fast simulation.
  ...
  return fTrack->GetTrackLength()/TG4G3Units::Length()
         + fInitialVMCTrackStatus->fCurrentTrackLength;
}
...
Int_t TG4StepManager::StepNumber() const
{
  ...
  return fTrack->GetCurrentStepNumber()
          + fInitialVMCTrackStatus->fCurrentStepNumber;
}
...
//_____________________________________________________________________________
void TG4StepManager::TrackPolarization(Double_t &polX, Double_t &polY,
                                  Double_t &polZ) const
{
