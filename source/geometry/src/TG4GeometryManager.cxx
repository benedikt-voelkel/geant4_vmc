...
/// Construct Geant4 geometry depending on user geometry source
  ...
  // NOTE Added verbosity
  G4cout << "TG4GeometryManager::ConstructG4Geometry: "
         << "construct geometry" << G4endl;
  ...
  if ( fUserGeometry == "VMCtoGeant4" ) {
    ...
    if ( VerboseLevel() > 1 )
      G4cout << "Running TVirtualMCApplication::ConstructGeometry VMC" << G4endl;
  ...
  if ( fUserGeometry == "RootToGeant4" && !fUseExternalGeometryConstruction) {
    ...
    G4cout << "TG4GeometryManager::ConstructG4Geometry: "
           << "construct geometry from ROOT" << G4endl;
...
//_____________________________________________________________________________
void TG4GeometryManager::SetExternalGeometryConstruction(G4bool value)
{
