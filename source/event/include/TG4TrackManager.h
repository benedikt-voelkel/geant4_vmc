...
class TG4TrackManager : public TG4Verbose
{
  public:
    ...
    void  NotifyOnRestoredGeometry(const G4Track* track);
    TG4TrackInformation* SetTrackInformation(const G4Track* aTrack,
  ...
  private:
    ...
    std::vector<TMCParticleStatus*>  fParticlesStatus; ///< The VMC stack particles status information
...
inline void
TG4TrackManager::SetMCManagerStack(TMCManagerStack* mcManagerStack) {
