...
/// Standard constructor
  ...
  if ( isMaster ) {
    ...
    configuration->SetExternalGeometryConstruction(UseExternalGeometryConstruction());
    configuration->SetExternalParticleGeneration(UseExternalParticleGeneration());
  }
  ...
  if ( isMaster ) {
    ...
    fGeometryManager->SetExternalGeometryConstruction(
