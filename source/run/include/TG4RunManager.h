...
class TG4RunManager : public TG4Verbose
{
  ...
  private:
    ...
    G4bool                fIsInterruptibleEvent; ///< Flag whether this event can be interrupted and resumed
    G4bool                fHasRunInitialization; ///< flag to check if run is initialized in GEANT4
