...
class TG4TrackInformation : public G4VUserTrackInformation
{
  public:
    ...
    void SetPDGEncoding(G4int pdgEncInitialoding);
  ...
  private:
    ...
    TMCParticleStatus* fInitialTrackStatus; ///< Pointer holds some additional
                                               ///< information on the particle
                                               ///< status e.g. for the case the
                                               /// < track has already been
                                               ///< transported up to the current
                                               ///< point in another engine.
};
